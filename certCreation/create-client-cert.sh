...
keytool -genkey -alias lydtech-client1 -dname "CN=client1.kafka.example.com, OU=TEST, O=LYDTECH, L=London, S=LN, C=UK" -keystore kafka.client1.keystore.jks -keyalg RSA -storepass changeit -keypass changeit
...
keytool -keystore kafka.client1.truststore.jks -alias CARoot -import -noprompt -file ca.crt -storepass changeit
